    ...
    <div className="admin-shell">
      ...
      <main className="admin-main">
        ...
        <p className="admin-lead">
          Public front and backend probes from the Cloudflare edge. Private / Tailscale-only APIs are listed but not
          probed, and their hostnames are not published.
        </p>
